...
print("Mostrando el indice [0] del elmento del arreglo numero->", numero[0] )
print("Mostrando el indice [1] del elmento del arreglo tareas->", tareas[1] )
print("Mostrando el indice [3] del elmento del arreglo diferentes_tipos_datos->", diferentes_tipos_datos[3] )
